TASK: bd daemon process accumulation causes CPU overload - multiple bd daemon processes spawn and accumulate over time. See bd-qgrf for full details. Root cause suspected in daemon_autostart.go race conditions.
...
1. Report via `bd comment bd-qgrf "Phase: Planning - [brief description]"`
...
2. Run: `bd comment bd-qgrf "Phase: Complete - [1-2 sentence summary of deliverables]"`
...
2. **SET UP investigation file:** Run `kb create investigation bd-daemon-process-accumulation-causes` to create from template
   - This creates: `.kb/investigations/simple/YYYY-MM-DD-bd-daemon-process-accumulation-causes.md`
   - This file is your coordination artifact (replaces WORKSPACE.md)
   - If command fails, report to orchestrator immediately
   - **IMPORTANT:** After running `kb create`, report the actual path via:
     `bd comment bd-qgrf "investigation_path: /path/to/file.md"`
...
6. **CREATE SYNTHESIS.md:** Before completing, create `SYNTHESIS.md` in your workspace: /Users/dylanconlin/Documents/personal/beads/.orch/workspace/og-debug-bd-daemon-process-24dec/SYNTHESIS.md
...
You were spawned from beads issue: **bd-qgrf**

**Use `bd comment` for progress updates instead of workspace-only tracking:**

```bash
# Report progress at phase transitions
bd comment bd-qgrf "Phase: Planning - Analyzing codebase structure"
bd comment bd-qgrf "Phase: Implementing - Adding authentication middleware"
bd comment bd-qgrf "Phase: Complete - All tests passing, ready for review"

# Report blockers immediately
bd comment bd-qgrf "BLOCKED: Need clarification on API contract"

# Report questions
bd comment bd-qgrf "QUESTION: Should we use JWT or session-based auth?"
```
...
**Why beads comments:** Creates permanent, searchable progress history linked to the issue. Orchestrator can track progress across sessions via `bd show bd-qgrf`.
...
1. Ensure SYNTHESIS.md is created and committed in your workspace.
2. `bd comment bd-qgrf "Phase: Complete - [1-2 sentence summary]"`
3. `/exit`
