TASK: Add source_repo field to bd list --json output. Currently bd list doesn't include source_repo even though SQLite stores it. The beads-ui-svelte multi-repo filtering depends on this field to filter issues by repository.

🚨 CRITICAL - FIRST 3 ACTIONS:
You MUST do these within your first 3 tool calls:
1. Report via `bd comment bd-zyk5 "Phase: Planning - [brief description]"`
...
2. Run: `bd comment bd-zyk5 "Phase: Complete - [1-2 sentence summary of deliverables]"`
...
2. **SET UP investigation file:** Run `kb create investigation add-source-repo-field-bd` to create from template
   - This creates: `.kb/investigations/simple/YYYY-MM-DD-add-source-repo-field-bd.md`
   - This file is your coordination artifact (replaces WORKSPACE.md)
   - If command fails, report to orchestrator immediately
   - **IMPORTANT:** After running `kb create`, report the actual path via:
     `bd comment bd-zyk5 "investigation_path: /path/to/file.md"`
...
6. **CREATE SYNTHESIS.md:** Before completing, create `SYNTHESIS.md` in your workspace: /Users/dylanconlin/Documents/personal/beads/.orch/workspace/og-feat-add-source-repo-21dec/SYNTHESIS.md
...
You were spawned from beads issue: **bd-zyk5**

**Use `bd comment` for progress updates instead of workspace-only tracking:**

```bash
# Report progress at phase transitions
bd comment bd-zyk5 "Phase: Planning - Analyzing codebase structure"
bd comment bd-zyk5 "Phase: Implementing - Adding authentication middleware"
bd comment bd-zyk5 "Phase: Complete - All tests passing, ready for review"

# Report blockers immediately
bd comment bd-zyk5 "BLOCKED: Need clarification on API contract"

# Report questions
bd comment bd-zyk5 "QUESTION: Should we use JWT or session-based auth?"
```
...
**Why beads comments:** Creates permanent, searchable progress history linked to the issue. Orchestrator can track progress across sessions via `bd show bd-zyk5`.
...
1. Ensure SYNTHESIS.md is created and committed in your workspace.
2. `bd comment bd-zyk5 "Phase: Complete - [1-2 sentence summary]"`
3. `/exit`
