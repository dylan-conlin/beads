TASK: Fix bd repo add to write to YAML instead of database. Currently bd repo add writes to DB config table but GetMultiRepoConfig() reads from .beads/config.yaml - disconnected stores. Make bd repo add/remove modify the YAML file so hydration sees the config. See .orch/workspace/og-inv-beads-multi-repo-21dec/SYNTHESIS.md

🚨 CRITICAL - FIRST 3 ACTIONS:
You MUST do these within your first 3 tool calls:
1. Report via `bd comment beads-untracked-1766380535 "Phase: Planning - [brief description]"`
...
2. Run: `bd comment beads-untracked-1766380535 "Phase: Complete - [1-2 sentence summary of deliverables]"`
...
2. **SET UP investigation file:** Run `kb create investigation fix-bd-repo-add-write` to create from template
   - This creates: `.kb/investigations/simple/YYYY-MM-DD-fix-bd-repo-add-write.md`
   - This file is your coordination artifact (replaces WORKSPACE.md)
   - If command fails, report to orchestrator immediately
   - **IMPORTANT:** After running `kb create`, report the actual path via:
     `bd comment beads-untracked-1766380535 "investigation_path: /path/to/file.md"`
...
6. **CREATE SYNTHESIS.md:** Before completing, create `SYNTHESIS.md` in your workspace: /Users/dylanconlin/Documents/personal/beads/.orch/workspace/og-feat-fix-bd-repo-21dec/SYNTHESIS.md
...
You were spawned from beads issue: **beads-untracked-1766380535**

**Use `bd comment` for progress updates instead of workspace-only tracking:**

```bash
# Report progress at phase transitions
bd comment beads-untracked-1766380535 "Phase: Planning - Analyzing codebase structure"
bd comment beads-untracked-1766380535 "Phase: Implementing - Adding authentication middleware"
bd comment beads-untracked-1766380535 "Phase: Complete - All tests passing, ready for review"

# Report blockers immediately
bd comment beads-untracked-1766380535 "BLOCKED: Need clarification on API contract"

# Report questions
bd comment beads-untracked-1766380535 "QUESTION: Should we use JWT or session-based auth?"
```
...
**Why beads comments:** Creates permanent, searchable progress history linked to the issue. Orchestrator can track progress across sessions via `bd show beads-untracked-1766380535`.
...
1. Ensure SYNTHESIS.md is created and committed in your workspace.
2. `bd comment beads-untracked-1766380535 "Phase: Complete - [1-2 sentence summary]"`
3. `/exit`
