...
func (m *mockStorage) CloseIssue(ctx context.Context, id string, reason string, outcome types.CloseOutcome, actor string) error {
	return nil
}
...
func (m *mockTransaction) CloseIssue(ctx context.Context, id string, reason string, outcome types.CloseOutcome, actor string) error {
	return nil
}
